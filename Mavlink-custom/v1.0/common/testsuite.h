...
static void mavlink_test_velocity_target_ned(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_VELOCITY_TARGET_NED >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_velocity_target_ned_t packet_in = {
		963497464,45.0,73.0,101.0
    };
	mavlink_velocity_target_ned_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_boot_ms = packet_in.time_boot_ms;
        packet1.vx = packet_in.vx;
        packet1.vy = packet_in.vy;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_velocity_target_ned_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_velocity_target_ned_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_velocity_target_ned_pack(system_id, component_id, &msg , packet1.time_boot_ms , packet1.vx , packet1.vy , packet1.vz );
	mavlink_msg_velocity_target_ned_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_velocity_target_ned_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_boot_ms , packet1.vx , packet1.vy , packet1.vz );
	mavlink_msg_velocity_target_ned_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_velocity_target_ned_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_velocity_target_ned_send(MAVLINK_COMM_1 , packet1.time_boot_ms , packet1.vx , packet1.vy , packet1.vz );
	mavlink_msg_velocity_target_ned_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_velocity_target_ned(system_id, component_id, last_msg);
